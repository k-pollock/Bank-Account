...
public class MoneyTest 
{
    ...
    public void testComplexAdd()
    {
        ...
        Money yourMoney = new Money (4, 60);
        
        //Expected result is $8.10
        Money expectedResult = new Money (8,10);
        Money actualResult = myMoney.add(yourMoney);
        
        assertTrue("Error in testComplexAdd", actualResult.equals(expectedResult));
    }
    
    @Test
    public void testSubtract()
    {
        //First test: difference of the cents 
        Money myMoney = new Money (4, 0);
        Money yourMoney = new Money (2, 50);
        
        //Expected result is $1.50
        Money expectedResult = new Money (1, 50);
        Money actualResult = myMoney.subtract(yourMoney);
        
        assertTrue ("Error in testSubtract", actualResult.equals(expectedResult));
    }

    
    //Test if two values of money are the same comparing money objects
    @Test
    public void testCompareTo()
    {
        ...
        Money myMoney = new Money(3, 50);
        //less then
        Money lMoney = new Money(2, 50);
        //same
        Money sameMoney = new Money(3, 50);
        //greater than
        Money gMoney = new Money(7, 00);
        
        int expected = 1;
        int actual = myMoney.compareTo(lMoney);
        assertTrue("Error in testCompareTo", expected == actual);
        
        int expected1 = 0;
        int actual1 = myMoney.compareTo(sameMoney);
        assertTrue("Error in testCompareTo", expected1 == actual1);
        
        int expected2 = -1;
        int actual2 = myMoney.compareTo(gMoney);
        assertTrue("Error in testCompareTo", expected2 == actual2); 
    }
